...
void handle_advert_info(Message msg, int sockfd)
{
	...
	switch(num)
	{
		case 0:
		{
	    	strcpy(back_msg.message, advert_1);
			break;
		}
		case 1:
		{
	    	strcpy(back_msg.message, advert_2);
		    break;
		}
		case 2:
		{
	    	strcpy(back_msg.message, advert_3);
		    break;
		}
		case 3:
		{
	    	strcpy(back_msg.message, advert_4);
		    break;
		}
		case 4:
		{
	    	strcpy(back_msg.message, advert_5);
		    break;
		}
		default:
		{

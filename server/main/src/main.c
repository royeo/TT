			...
			if(FD_ISSET(sfd, &rset))
			{
				...
				else
				{
					...
					{	
						...
						{
						    printf("\n用户%s修改个性签名！\n", msg.user);
							handle_modify_signature(msg,sfd);
							break;
						}
						...
						{
						    printf("用户%s请求修改密码！\n", msg.user);
							handle_change_password(msg, sfd);
							break;
						} 
						...
						{
							printf("用户%s请求修改昵称！\n", msg.user);
							handle_modify_nickname(msg, sfd);
							break;
						}
